...
<aside class="sidebar">
    <div class="logo-wrap">
        ...
        <div class="logo-name">Amichi<br>De Gusto</div>
        <div class="logo-sub">Italian Restaurant</div>
    </div>
    <div class="ornament">◆</div>
    <nav>
        <a class="nav-item" href="dashboard.html"><span class="nav-icon">🏠</span> Dashboard</a>
        <a class="nav-item active" href="order.html"><span class="nav-icon">📋</span> Order Management</a>
        <a class="nav-item" href="menu.html"><span class="nav-icon">🍴</span> Menu Management</a>
        <a class="nav-item" href="billing.html"><span class="nav-icon">🧾</span> Billing System</a>
    </nav>
</aside>
    ...
    <div class="order-content">
        ...
        <div class="order-stats">
            <div class="ostat-card">
                ...
                <div class="ostat-value v-red" id="total-orders">7</div>
            </div>
            <div class="ostat-card">
                ...
                <div class="ostat-value v-gold" id="pending-orders">2</div>
            </div>
            <div class="ostat-card">
                ...
                <div class="ostat-value v-blue" id="ready-orders">1</div>
            </div>
            <div class="ostat-card">
                ...
                <div class="ostat-value v-green" id="completed-orders">1</div>
            </div>
        </div>
                ...
                <table class="orders">
                    ...
                    <tr>
                        ...
                        <td><div class="act-wrap">
                            <button class="abtn abtn-accept">Accept</button>
                            <button class="abtn abtn-completed">Completed</button>
                        </div></td>
                    </tr>
                    <tr>
                        ...
                        <td><div class="act-wrap">
                            <button class="abtn abtn-preparing">Preparing</button>
                            <button class="abtn abtn-completed">Completed</button>
                        </div></td>
                    </tr>
                    <tr>
                        ...
                        <td><div class="act-wrap">
                            <button class="abtn abtn-preparing">Preparing</button>
                            <button class="abtn abtn-ready">Ready</button>
                            <button class="abtn abtn-completed">Completed</button>
                        </div></td>
                    </tr>
                    <tr>
...
<script>
    ...
    /* ── Update a row when a button is clicked ── */
    function updateOrderStatus(button, newStatus) {
        ...
        /* update badge */
        const badge = statusCell.querySelector('.sbadge');
        badge.className   = 'sbadge ' + (statusToClass[newStatus] || '');
        badge.textContent = newStatus;

        /* update buttons */
        let html = '';
        if (newStatus === 'Accepted') {
            html = `<button class="abtn abtn-preparing">Preparing</button>
                    <button class="abtn abtn-completed">Completed</button>`;
            ...
            html = `<button class="abtn abtn-ready">Ready</button>
                    <button class="abtn abtn-completed">Completed</button>`;
        } else if (newStatus === 'Completed') {
            html = <span class="abtn-done-text">Order Complete</span>;
        }
        actionsCell.querySelector('.act-wrap').innerHTML = html;

        updateSummary();
    }

    /* ── Recount summary cards ── */
    function updateSummary() {
        const rows = document.querySelectorAll('#orders-tbody tr');
        let pending = 0, ready = 0, completed = 0;
        rows.forEach(row => {
            const t = row.cells[3].querySelector('.sbadge').textContent;
    ...
    document.getElementById('orders-tbody').addEventListener('click', function (e) {
        ...
        if (!btn) return;
        const status = btnLabelToStatus[btn.textContent.trim()];
        if (status) updateOrderStatus(btn, status);
    });
</script>
</body>
</html>
